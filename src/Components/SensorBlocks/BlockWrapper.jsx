...
function BlockWrapper(props) {
  ...
  return (
    <>
      ...
      <div className="col-md-6 big-wrapper-outer">
              ...
              item.name === "coordinates" ? (
                <>
                  ...
                  <div className="d-flex  second-block">
                    ...
                    <div className="col-md-4 big-blocks-wrapper">
                      <div className="big-blocks-inner">
                        <img src={alert} alt="" />
                        <p>Alert</p>
                  ...
                  {/* <hr /> */}
                  {/* <div
                    className="d-flex big-wrapper-middle third-block"
                    style={{ display: "none" }}
                  >
                    <div className="big-blocks-wrapper">
                      <div className="big-blocks-inner">
                        ...
                        <br />
                        <span>New York Street 1asass</span>
                      </div>
                    </div>
                  </div> */}
